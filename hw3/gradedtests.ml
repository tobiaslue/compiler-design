...
let arg_loc_tests =
  ...
  [ ("arg_loc0", assert_eqf (fun () -> arg_loc 0) (Reg Rdi))
  ; ("arg_loc1", assert_eqf (fun () -> arg_loc 1) (Reg Rsi))
  ; ("arg_loc2", assert_eqf (fun () -> arg_loc 2) (Reg Rdx))
  ; ("arg_loc3", assert_eqf (fun () -> arg_loc 3) (Reg Rcx))
  ; ("arg_loc4", assert_eqf (fun () -> arg_loc 4) (Reg R08))
  ; ("arg_loc5", assert_eqf (fun () -> arg_loc 5) (Reg R09))                
  ; ("arg_loc6", assert_eqf (fun () -> arg_loc 6) (rbp_offset 2))
  ; ("arg_loc7", assert_eqf (fun () -> arg_loc 7) (rbp_offset 3))
  ; ("arg_loc17", assert_eqf (fun () -> arg_loc 17) (rbp_offset 13))
  ]
